...
import {
  consultarDocumentoPorLote,
  consultarDocumentoPorCDC,
  generarEventoCancelacion,
} from "../api/documentos";
...
export function ConsultasDocumentos() {
  ...
  const handleConsultarLote = async () => {
    ...
    try {
      ...
      const mensaje =
        error instanceof Error ? error.message : "Error al consultar el lote";
  ...
  const handleConsultarCdc = async () => {
    ...
    try {
      ...
      const mensaje =
        error instanceof Error ? error.message : "Error al consultar el CDC";
      toast.error("Error en la consulta", {
        description: mensaje,
        duration: 5000,
      });
  ...
  const handleCancelarDocumento = async () => {
    ...
    if (
      !window.confirm(
        "¿Está seguro de que desea cancelar este documento? Esta acción no se puede deshacer."
      )
    ) {
      return;
    }
      ...
      <Tabs defaultValue="lote" className="w-full">
        ...
        <TabsContent value="lote" className="mt-6">
          <Card className="p-6">
            <h2 className="text-lg font-semibold">
              Consultar Documentos por Número de Lote
            </h2>
            <p className="text-sm text-gray-600">
              Ingrese el número de lote para consultar todos los documentos
              asociados
            </p>
        ...
        <TabsContent value="cdc" className="mt-6">
          <Card className="p-6">
            ...
            <p className="text-sm text-gray-600">
              Ingrese el CDC (Código de Control del Documento) para consultar su
              estado
            </p>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-800">
                    Una vez cancelado un documento, no podrá ser revertido.
                    Asegúrese de ingresar el CDC correcto.
                  </p>
                </div>
              </div>
            </div>
